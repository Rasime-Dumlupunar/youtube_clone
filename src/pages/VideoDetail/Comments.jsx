        ...
        <div key={index} className='flex gap-2 items-start px-1 py-4'>
            ...
            <div className='flex flex-col gap-2 '>
                ...
                <div className='flex items-center gap-5'>
                    <div className='flex gap-1 items-center p-1 hover:bg-gray-700 cursor-pointer rounded'>
                        <AiFillLike />
                        <span className='text-gray-400'>{i.likesCount} </span>
                    </div>
                    <div className='p-1 hover:bg-gray-700 cursor-pointer rounded'>
                        <AiFillDislike />
                    </div>

                    <span className='p-1 cursor-pointer rounded hove: bg-gray-700'> Yanıtla</span>
                </div>
                {i.replyCount > 0 && (
